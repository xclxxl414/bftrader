...
class BfProxyService GRPC_FINAL {
 public:
  ...
  typedef WithAsyncMethod_OnTradeWillBegin<WithAsyncMethod_OnPing<WithAsyncMethod_OnTick<WithAsyncMethod_OnError<WithAsyncMethod_OnLog<WithAsyncMethod_OnTrade<WithAsyncMethod_OnOrder<WithAsyncMethod_OnPosition<WithAsyncMethod_OnAccount<Service > > > > > > > > > AsyncService;
  template <class BaseClass>
