...
protoc -I . --python_out=python --grpc_out=python --plugin=protoc-gen-grpc=../third_party/grpc/bin/grpc_python_plugin.exe ./bfcta.proto --proto_path=../third_party/grpc/include
