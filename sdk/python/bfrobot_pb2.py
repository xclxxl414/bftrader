...
class BetaBfRobotServiceStub(object):
  ...
  @abc.abstractmethod
  def OnTradeClosed(self, request, timeout):
    raise NotImplementedError()
  OnTradeClosed.future = None
...
def beta_create_BfRobotService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  request_deserializers = {
    ...
    ('bftrader.bfrobot.BfRobotService', 'OnTradeClosed'): bftrader_pb2.BfVoid.FromString,
  }
  response_serializers = {
    ...
    ('bftrader.bfrobot.BfRobotService', 'OnTradeClosed'): bftrader_pb2.BfVoid.SerializeToString,
  }
  method_implementations = {
    ...
    ('bftrader.bfrobot.BfRobotService', 'OnTradeClosed'): face_utilities.unary_unary_inline(servicer.OnTradeClosed),
  }
...
def beta_create_BfRobotService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  cardinalities = {
    ...
    'OnTradeClosed': cardinality.Cardinality.UNARY_UNARY,
  }
